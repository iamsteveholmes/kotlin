...
public class KotlinLightMethodFromTraitImpl(manager: PsiManager,
        ...
        KotlinLightMethodFromTrait {

    override fun copy(): PsiElement {
        return KotlinLightMethodFromTraitImpl(getManager()!!, delegate, origin.copy() as JetDeclaration, getContainingClass()!!)
    }
}