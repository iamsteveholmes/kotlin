...
public class InlineDescriptorUtils {
    ...
    public static boolean checkNonLocalReturnUsage(@NotNull DeclarationDescriptor fromFunction, @NotNull JetExpression startExpression, @NotNull BindingTrace trace) {
        PsiElement containingFunction = getContainingClassOrFunction(startExpression);
        ...
        containingFunction = BindingContextUtils.descriptorToDeclaration(bindingContext, containingFunctionDescriptor);
        if (containingFunction == null) {
            return false;
        }
    ...
    @Nullable
    public static PsiElement getContainingClassOrFunction(JetExpression expression) {
        do {
