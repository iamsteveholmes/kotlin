...
class NoInternalVisibilityInStdLibTest {
    private class OutputSink(private val requiredPackages: List<FqName>) {
        ...
        fun reportErrors() {
            ...
            assertTrue(
                    validatedPackages.containsAll(requiredPackages),
    ...
    Test fun testJvmStdlib() {
        doTest(PACKAGES_SHOULD_BE_VALIDATED_FOR_JVM, "kotlin") {
    ...
    private fun doTest(requiredPackages: List<FqName>, vararg testPackages: String, createTestModule: (disposable: Disposable) -> ModuleDescriptor) {
        ...
        val sink = OutputSink(requiredPackages)
