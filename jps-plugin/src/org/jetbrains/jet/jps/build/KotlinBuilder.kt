...
public class KotlinBuilder protected() : ModuleLevelBuilder(BuilderCategory.SOURCE_PROCESSOR) {

    override fun getPresentableName(): String {
        return KOTLIN_BUILDER_NAME
    }

    throws(javaClass<ProjectBuildException>(), javaClass<IOException>())
    override fun build(
        ...
        val hasKotlinFiles = hasKotlinDirtyOrRemovedFiles(dirtyFilesHolder, chunk)
        if (!hasKotlinFiles) {
            return ModuleLevelBuilder.ExitCode.NOTHING_DONE
        }
        ...
        var recompilationDecision: IncrementalCacheImpl.RecompilationDecision = IncrementalCacheImpl.RecompilationDecision.DO_NOTHING
    ...
    override fun buildStarted(context: CompileContext?) {
        super<ModuleLevelBuilder>.buildStarted(context)
    }
    ...
    public class MessageCollectorAdapter(private val context: CompileContext) : MessageCollector {
        ...
        override fun report(severity: CompilerMessageSeverity, message: String, location: CompilerMessageLocation) {
            ...
            context.processMessage(CompilerMessage(
                    ...
                    -1L,
                    -1L,
                    location.getLine().toLong(),
                    location.getColumn().toLong()
            ))
        }
    ...
    override fun getCompilableFileExtensions(): MutableList<String> {
    ...
    class object {
        ...
        private val COMPILABLE_FILE_EXTENSIONS = arrayListOf("kt")
